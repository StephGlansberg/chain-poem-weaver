...
Generated: 2026-06-23T21:13:39.342Z
...
- Blockers: miniapp_origin_missing, account_association_header_missing, account_association_payload_missing, account_association_signature_missing, server_capable_deploy_provider_not_ready, dist_not_built_in_production_mode, production_origin_missing, dist_manifest_uses_placeholder_domain, deploy_target:miniapp_origin_missing, deploy_target:account_association_header_missing, deploy_target:account_association_payload_missing, deploy_target:account_association_signature_missing, deploy_target:server_capable_deploy_provider_not_ready
...
- data/client-verification.json: required; filled from data/client-verification.template.json after live Farcaster/Base client testing.
...
1. Fill data/client-verification.json with live client evidence
